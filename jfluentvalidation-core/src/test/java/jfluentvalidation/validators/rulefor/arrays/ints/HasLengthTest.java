...
class HasLengthTest {
    ...
    void shouldNotReturnFailureWhenActualLengthIsEqualToExpected() {
        ...
        validator.ruleForIntArray(Target::getValue).hasLength(1);
    ...
    void shouldReturnFailureWhenActualLengthIsNotEqualToExpected() {
        ...
        DefaultValidator<Target> validator = new DefaultValidator<>(Target.class);
        validator.ruleForIntArray(Target::getValue).hasLength(2);
    ...
    void shouldThrowIllegalArgumentExceptionWhenExpectedLengthIsNegative() {
        DefaultValidator<Target> validator = new DefaultValidator<>(Target.class);
        assertThrows(IllegalArgumentException.class, () -> validator.ruleForIntArray(Target::getValue).hasLength(-1));
    }
}
